...
| A. Tempia Calvino et al. | EPFL and UC Berkeley | LUT mapping with Boolean decomposition | Based on the delay-driven LUT mapping algorithm with Boolean decomposition presented in [A. Tempia Calvino, G. De Micheli, A. Mishchenko, and R. Brayton: Enhancing Delay-Driven LUT Mapping With Boolean Decomposition, TCAD, 2025](https://ieeexplore.ieee.org/abstract/document/10673978) |
| A. Costamagna et al. | EPFL and UC Berkeley | Information graph-based resubstitution | Based on the information graph-based resubstitution method presented in [A. Costamagna, A. Tempia Calvino, A. Mishchenko, and G. De Micheli: Area-Oriented Resubstitution For Networks of Look-Up Tables, TCAD, 2025](https://ieeexplore.ieee.org/abstract/document/10820546) |
