...
|  **Multiplier**  |  **128**  | **128**  | **4360**    | **163**  | **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
...
| Benchmark name | Inputs | Outputs | LUT-6 count | Levels | Authors | Method |
| ------------- | ------------- | ------------- |-------------|--------| ------------- | ------------- |
|  **Round-robin arbiter**  |  **256**   |  **129**   | **270**     | **66** | **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
...
| Barrel shifter  | 135 |128  | 512         |4  | R. K. Brayton & A. Mishchenko|ABC Extreme Mapper|
| **Divisor**  | **128** | **128**  | **23922**   | **179** | **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
| **Hypotenuse** | **256** | **128**  | **176937**  | **493** | **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
|  **Log2**  | **32**  | **32**  | **8715**    | **52**  |  **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
|  **Max** |  **512**  | **130**  | **1201**    | **7** |  **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
| **Multiplier** | **128** | **128** | **12851**   | **25** | **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
|  **Sine**  |  **24**  | **25**  | **681558**  | **10** | **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
|  **Square-root**  |  **128**  | **64**  | **41599**   | **173** |  **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
...
|  **Int to float converter**  |  **11**  | **7**  | **20**      | **3**  |  **T. Besson** | **ABC-DE: ABC Design Explorer** |
|  **Memory controller**  |  **1204**  | **1231**  | **1888**    | **5** | **A. Grosnit, C. Feng, X. Li, et al.** | **NAILS** |
